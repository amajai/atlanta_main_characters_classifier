...
export_file_url = 'https://coc-cv-datasets.s3.eu-west-2.amazonaws.com/Atlanta_main_characters_identifier_model/full_model_export1.pkl'
...
classes = ['Alfred(Paperboy)', 'Darius', 'Earn']
